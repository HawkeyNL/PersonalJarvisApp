...
val releaseVersionName = providers.environmentVariable("JARVIS_APP_VERSION").orNull ?: "0.1.12"
...
val releaseVersionCode = providers.environmentVariable("JARVIS_ANDROID_VERSION_CODE").orNull?.toIntOrNull() ?: 13
